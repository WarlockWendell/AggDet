...
from .aggdet_fast_rcnn import AggdetFastRCNNOutputLayers
from ..debug import debug_second_stage

from torch.cuda.amp import autocast

@ROI_HEADS_REGISTRY.register()
class AggdetCascadeROIHeads(CascadeROIHeads):
    @configurable
    def __init__(
        self,
        *,
    ...
    def _forward_box(self, features, proposals, overlaps, targets=None, 
    ...
    def forward(self, images, features, proposals, overlaps, targets=None,
        ann_type='box', classifier_info=(None,None,None)):
        '''
        ...
        if self.training:
            ...
            pred_instances = self._forward_box(
                features, proposals, overlaps, classifier_info=classifier_info)
