...
def add_aggdet_config(cfg):
    ...
    _C.MODEL.OVERLAP_TOPK = 4
    _C.MODEL.ALPHA = 0.01
    _C.MODEL.BETA = 0.75
    _C.MODEL.VISUAL_PROTOTYPE = 'datasets/prototypes/Detic_COCO_RN50.npy'
    _C.MODEL.CATEGORIES_INFO = 'datasets/metadata/coco_categories_info.json'
